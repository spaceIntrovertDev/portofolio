        ...
        <section className="space-y-12">
          <div className="group">
            ...
            <ul className="mt-3 list-disc space-y-1 pl-6 text-base text-gray-700 dark:text-gray-300">
              <li>
                Backend software development with PHP and TypeScript (Node.js
                and Prisma)
              </li>
              <li>
                Management and maintenance of the MySQL database using SQL
              </li>
              <li>
                Implementation of interface integrations according to customer
                requirements (SOAP and REST)
              </li>
          ...
          <div className="group border-t border-gray-200 pt-10 dark:border-gray-700">
            ...
            <ul className="mt-3 list-disc space-y-1 pl-6 text-base text-gray-700 dark:text-gray-300">
              <li>
                Backend software development with PHP (CakePHP/Laravel),
                TypeScript (Node.js) and Python (Flask)
              </li>
              <li>
                Management and maintenance of the MySQL database using SQL and
                the Elasticsearch (NoSQL) database
              </li>
              <li>
                Optimization of the search algorithm in the Elasticsearch
                database using Natural Language Processing (NLP) and integration
