import { Code2, Brain, Database, GitBranch, TestTube, Globe, Cpu, Layers } from "lucide-react";
            ...
            <article className="w-full max-w-3xl space-y-10 rounded-lg bg-white p-8 shadow-lg dark:bg-black">
                ...
                <section>
                    ...
                    <div className="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h3 className="font-medium text-orange-700 dark:text-orange-400">Basic Knowledge</h3>
                            <p className="mt-1 text-base text-gray-700 dark:text-gray-300">
                ...
                <section className="border-t border-gray-200 pt-8 dark:border-gray-700">
                    ...
                    <div className="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            <h3 className="font-medium text-purple-700 dark:text-purple-400">Backend</h3>
                        ...
                        <div>
                            <h3 className="font-medium text-teal-700 dark:text-teal-400">Frontend & Tools</h3>
                            <ul className="mt-2 space-y-1 text-base text-gray-700 dark:text-gray-300">
                                <li>Next.js</li>
                                <li>React</li>
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <p className="font-medium text-gray-900 dark:text-white">Databases</p>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <p className="font-medium text-gray-900 dark:text-white">Testing</p>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <p className="font-medium text-gray-900 dark:text-white">DevOps</p>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <p className="font-medium text-gray-900 dark:text-white">APIs & Integrations</p>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <p className="font-medium text-gray-900 dark:text-white">Advanced Topics</p>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
