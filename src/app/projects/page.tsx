      ...
      <article className="w-full max-w-3xl space-y-12 rounded-lg bg-white p-8 shadow-lg dark:bg-black">
        <header className="border-b border-gray-200 pb-6 dark:border-gray-700">
          ...
          <p className="mt-2 text-center text-base text-gray-600 dark:text-gray-400 sm:text-left">
            Academic and self-directed learning projects showcasing full-stack
            development
          </p>
        </header>
        <section className="space-y-6">
          ...
          <p className="text-base leading-relaxed text-gray-700 dark:text-gray-300">
            A full-stack data pipeline for analyzing Twitter (X) data with
            custom weighting schemes. Includes crawling, database migration,
            re-crawling logic and interactive analysis dashboard.
          </p>
        ...
        <section className="space-y-6">
          ...
          <p className="text-base leading-relaxed text-gray-700 dark:text-gray-300">
            ...
            Analyzes code context, searches documentation and provides instant
            help via natural language.
          </p>
          <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            <li className="flex items-center gap-2">
